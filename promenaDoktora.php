...
<body>
    ...
    <?php
        $sql = "SELECT IdDoktora,ImeDoktora,PrezimeDoktora,IdPacijenta,JmbgPacijenta,ImePacijenta,PrezimePacijenta,EmailPacijenta FROM promenidoktor;";
        $result = $conn->query($sql);
        if($result->num_rows > 0){
            echo "<h2>Zahtevi za promenu doktora</h2>";
            ...
            echo "<h1>Trenutno nema zahteva za promenu doktora</h1>";
        }
    ?>

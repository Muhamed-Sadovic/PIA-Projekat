...
<body>
    ...
    <?php
        if(isset($_GET["error"])){
            ...
            if($_GET["error"] == "pogresanInput"){
                echo'<script>alert("Neispravno korisničko ime/email ili lozinka")</script>';
            }
            if($_GET["error"] == "uspešnoVerifikovan"){
                echo'<script>alert("Uspešno ste verifikovali nalog. Prijavite se za konačan pristup")</script>';
            }  
            if($_GET["error"] == "nijeVerifikovan"){
                echo'<script>alert("Nalog Vam nije verifikovan")</script>';
            }
            if($_GET["error"] == "nijeOdobren"){
                echo'<script>alert("Na Vašem mailu ce Vam stići obaveštenje o prihvatanju ili odbijanju zahteva.")</script>';
            }
        }
    ?>

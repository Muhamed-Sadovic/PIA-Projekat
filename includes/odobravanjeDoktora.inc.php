        ...
        $messageee = 
            "<div style=' border: 1px solid grey;width: 340px; height: 350px; background-color: rgb(252, 252, 252); overflow: hidden; border-radius: 15px;'>
                ...
                <div style='padding: 10px;'>
                    ...
                    <h4>Uspešno Vam je odobren zahtev za doktora.</h4>
                    <h4>Link ispod vas vodi do stranice gde treba da upišete vaše podatke za konačan pristup.</h4>
                    <h4>Vaš Username: ".$username."</h4>
                    <a href='http://localhost/ProjekatPhp/login.php?jmbg=$jmbg'>Klikni</a>
                </div>
            </div>";
